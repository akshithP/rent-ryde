...
const ContactForm = () => {
  return (
    <div id="mainContactForm" className="grid grid-cols-2 p-10 gap-14">
      {/*-----------------FIRST NAME----------------*/}
      <div id="firstName" className="flex flex-col gap-2">
        ...
        <input
          ...
          className="p-3 bg-transparent outline-none border-b-4 border-borderCol text-lg font-normal text-textPrimary placeholder:italic placeholder:text-base placeholder:font-light"
        ></input>
      </div>
